...
class ClientModel(Base):
    ...
    membership_expires_at: Mapped[datetime] = mapped_column(
...
class PurchaseModel(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "gross_amount >= 0",
            name="ck_purchases_gross_amount_non_negative",
        ),
        CheckConstraint(
            "discount_amount >= 0",
            name="ck_purchases_discount_amount_non_negative",
        ),
        CheckConstraint(
            "discount_amount <= gross_amount",
            name="ck_purchases_discount_not_above_gross",
        ),
    )
