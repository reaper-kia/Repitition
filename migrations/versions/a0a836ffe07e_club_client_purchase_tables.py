...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_clubs_manager_user_id"), "clubs", ["manager_user_id"], unique=False
    )
    op.create_table(
        "clients",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["referred_by_client_id"], ["clients.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        op.f("ix_clients_referred_by_client_id"),
        "clients",
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "discount_amount >= 0", name="ck_purchases_discount_amount_non_negative"
        ),
        sa.CheckConstraint(
            "gross_amount >= 0", name="ck_purchases_gross_amount_non_negative"
        ),
    ...
    op.create_index(
        op.f("ix_purchases_client_id"), "purchases", ["client_id"], unique=False
    )
    op.create_index(
        op.f("ix_purchases_club_id"), "purchases", ["club_id"], unique=False
    )
    op.create_index(
        op.f("ix_purchases_confirmed_at"), "purchases", ["confirmed_at"], unique=False
    )
